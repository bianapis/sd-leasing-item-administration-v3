...
/**
 * BQAssuranceInitiateOutputModel
 */
public class BQAssuranceInitiateOutputModel   {
  private String assuranceInstanceReference = null;

  private String assuranceInitiateActionReference = null;

  private Object assuranceInitiateActionRecord = null;

  private String assuranceInstanceStatus = null;
  ...
  **/
   ...
   * @return assuranceInitiateActionReference
  **/

  public String getAssuranceInitiateActionReference() {
    return assuranceInitiateActionReference;
  }

  public void setAssuranceInitiateActionReference(String assuranceInitiateActionReference) {
    this.assuranceInitiateActionReference = assuranceInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Assurance instance (e.g. initialised, pending, active) 
   * @return assuranceInstanceStatus
  **/

  public String getAssuranceInstanceStatus() {
    return assuranceInstanceStatus;
  }

  public void setAssuranceInstanceStatus(String assuranceInstanceStatus) {
    this.assuranceInstanceStatus = assuranceInstanceStatus;
  }
